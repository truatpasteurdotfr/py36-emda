...
setup(name= 'emda',
    ...
    long_description='''\
        Library for Electron Microscopy map and model
        manipulations. To work with MRC/CCP4.MAP as well as MTZ files in map to map
    ...
    author_email= 'ranganaw@mrc-lmb.cam.ac.uk',
    license= 'MPL 2.0',
